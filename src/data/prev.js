...
export const prev = {
    ...
    projects: {
        ...
        swagball: {
            tags: ['springbox', 'production'],
            id: 'springbox-dell-swag-ball',
        ...
        steameffect: {
            tags: ['springbox', 'prototype', 'motion'],
            id: 'springbox-lg-steam-particles',
        ...
        scion1: {
            tags: ['springbox', 'prototype'],
            id: 'springbox-scion-configurator',
        ...
        screensaver: {
            tags: ['springbox', 'exclude', 'motion'],
            id: 'springbox-screensaver',
        ...
        imageviewer: {
            tags: ['springbox', 'exclude', 'production'],
            id: 'springbox-livestrong-viewer',
        ...
        homepagerotator: {
            tags: ['springbox', 'exclude', 'motion'],
            id: 'springbox-livestrong-rotator',
        ...
        steamlaundry: {
            tags: ['springbox', 'production', 'motion'],
            id: 'springbox-lg-steam',
