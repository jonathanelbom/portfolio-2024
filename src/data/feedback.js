...
export const _feedback = [
    {
        ...
        // descr: "I had the pleasure of working with Jonathan at Indeed on several projects, where he was the Lead UX Developer. Jonathan possesses extensive knowledge in UX design and frontend technology. Shortly after joining the team, Jonathan evangelized modern UX technology and best practices, driving the effort to help the team adopt new technologies and enhance maintainability. Jonathan is a strong advocate for user-first design, always aiming to create intuitive UX experiences. He has a keen product sense and excels at navigating complex feature development processes. His ability to adapt and perform in a fast-paced environment is impressive. Jonathan is highly collaborative and fun to work with. I greatly enjoyed our time working together and would love to have the opportunity to collaborate with him again in the future.",
        assets: [],
    ...
    },
    {
        ...
        // descr: "I had the pleasure of working on the same team with Jonathan at Indeed and from the moment he joined, he showed enthusiasm for solving problems and identifying ways to improve our processes. His extensive knowledge in UX and front end development enabled him to provide valuable insights during UX reviews and facilitate clear communication with engineers. Jonathan is proactive, a strong communicator, an advocate for the user and just an awesome person to work with. He had an exceptional reputation at the company, his skills are invaluable and I can't recommend him enough!"
        assets: [],
        imageBgColor: 'transparent',
        links: [],
    ...
    },
    {
        ...
        title: 'Li S.',
        role: '',
        descr: 'Jonathan is such a treasure cove of knowledge and patience for anyone who strives to be a good engineer. Even after a bit of time, I still think back to our learning sessions and my notes. It’s obvious user experiences and technology is his passion and he encapsulates everything I strive to be as an engineer. His mentorship is priceless and I have been so lucky to learn from him.',
        assets: [],
        imageBgColor: 'transparent',
        links: [],
        sizes: ['UX Developer'],
    },
    {
        ...
        title: 'Stephanie O.',
        role: '',
        descr: 'Jonathan is a strong UX developer who always has an eye for consistency and the user experience. He quickly became a trusted resource as I worked with him on a project on Indeed. He raised and helped resolve a11y issues as we worked through design iterations, and collaborated well with engineering, product, and designers on the team. He created documentation to guide others on the project with less front-end experience and overall helped the project move forward quickly and in a positive way. Any team who he works with will benefit from his experience and ability to address and solve both UX and engineering problems.',
        assets: [],
        imageBgColor: 'transparent',
        links: [],
        sizes: ['UX Content Designer'],
    },
    {
        tags: ['feedback'],
        id: 'saachik',
        title: 'Saachi K.',
        role: '',
        descr: 'Jonathan was a very strong UX developer and lead at Indeed, and we had the opportunity to work together on a prototype for a large project to redesign the job seeker profile experience on Indeed. I also saw that he shared valuable feedback on UX designs across multiple projects, and always took into consideration accessibility for users. In our work together, he was a very direct and clear communicator, extremely proactive in identifying potential issues, and very organized and meticulous in his approach to his work.',
        assets: [],
        imageBgColor: 'transparent',
        links: [],
        sizes: ['UX Designer'],
