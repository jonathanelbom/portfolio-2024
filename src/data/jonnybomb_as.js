...
export const _jonnybomb_as = [
    {
        tags: ['freelance', 'production', 'motion'],
        id: 'freelance-suddenly-almost-nearly',
    ...
    {
        tags: ['freelance', 'prototype'],
        id: 'freelance-ut-wayfinder',
    ...
    {
        tags: ['freelance', 'exclude', 'production'],
        id: 'freelance-rapid-ric',
        title: 'DJ Rapid Ric',
        role: 'Lead Designer and Developer',
    ...
    {
        tags: ['pearson', 'exclude', 'production'],
        id: 'pearson-abbi-old',
        title: 'ABBI',
    ...
    {
        tags: ['freelance', 'exclude', 'production'],
        id: 'freelance-mentalmodeler-old',
        title: 'MentalModeler',
